...
data class WallpaperProject(
    ...
    val selectedPipeline: AiPipelineChoice = AiPipelineChoice.UNIVERSAL_CASCADE,
    ...
    companion object {
        fun fromJson(json: JSONObject): WallpaperProject = WallpaperProject(
            ...
            selectedPipeline = runCatching { AiPipelineChoice.fromId(json.optString("selectedPipeline", "UNIVERSAL_CASCADE")) }.getOrDefault(AiPipelineChoice.UNIVERSAL_CASCADE),
