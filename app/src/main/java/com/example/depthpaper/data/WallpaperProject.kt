...
data class WallpaperProject(
    ...
    val processingMode: ProcessingMode = ProcessingMode.SINGLE_MODEL,
    val depthLayerCount: Int = 8,
    val selectedModel: AiModelChoice = AiModelChoice.SELFIE_MULTICLASS,
    ...
    companion object {
        fun fromJson(json: JSONObject): WallpaperProject = WallpaperProject(
            ...
            processingMode = runCatching { ProcessingMode.valueOf(json.optString("processingMode", "SINGLE_MODEL")) }.getOrDefault(ProcessingMode.SINGLE_MODEL),
            selectedModel = runCatching { AiModelChoice.fromId(json.optString("selectedModel", "SELFIE_MULTICLASS")) }.getOrDefault(AiModelChoice.SELFIE_MULTICLASS),
